...
$query ="SELECT rider.*,DATE(rider.datetime) as reg_date,rider_details.* FROM rider 
JOIN rider_details ON rider.code = rider_details.code ORDER BY rider.id ASC"; 
...
<div class="row">
    <div class="col-sm-3">
    <a href="admin">Dashboard</a>: Rider List
    </div>
</div>
  <div class="row">
    <div class="col-sm-3">
  ...
  <div class="row">
        ...
        <div class="card">
            <div class="card-body">
            <h2 class="card-title text-center">Rider List</h2>
                ...
                <td><?php echo $row['code']?></td>
                  ...
                  <td><?php $approvel = $row['status'];
                   if($approvel === 'Active' or $approvel === 'Inactive'){
                      if($approvel === 'Inactive'){?>
                    <a href="backend/rider_confimation?active=<?php echo $row['code']?>" class="btn btn-primary"style="border-radius: 20px;">Make Active</a>
                    <?php }
                      else{?>
                       <a href="backend/rider_confimation?inactive=<?php echo $row['code']?>" class="btn btn-warning"style="border-radius: 20px;">Make Inactive</a>
                      <?php }
                       }
                      else{?>
