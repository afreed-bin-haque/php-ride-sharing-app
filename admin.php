                ...
                <td><?php echo $row['rider_code']?></td>
                  ...
                  <td><?php $approvel = $row['approvel'];
                   if($approvel === 'Approved' or $approvel === 'Unapproved'){
                      if($approvel === 'Unapproved'){?>
                    <a href="backend/book_confirmation?apporve=<?php echo $row['user_code']?>" class="btn btn-primary"style="border-radius: 20px;">Approve</a>
                    <?php }
                      else{?>
                       <a href="backend/book_confirmation?unapprove=<?php echo $row['user_code']?>" class="btn btn-warning"style="border-radius: 20px;">Unapprove</a>
                      <?php }
                       }
                      else{?>
